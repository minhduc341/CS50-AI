...
def shortest_path(source, target):
    ...
    start = Node(state = source, parent = None, action = None) #state = actor, action = movie
    frontier = StackFrontier()
    frontier.add(start)

    # Start with an empty explored set (explored actor):
    explored_set = set()
    ...
    while True:
        ...
        # If node not contains goal state, Add the node to the explored set:
        explored_set.add(node.state)

        # Expand node (find neighbour):
